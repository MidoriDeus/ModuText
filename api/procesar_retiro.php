...
try {
    ...
    $mail->SMTPAuth = true;
    $mail->Username = $_ENV['EMAIL_USERNAME'] ?? 'drackracer@gmail.com';
    $mail->Password = $_ENV['EMAIL_PASSWORD'] ?? 'iyphkooslbxszvsc';
    ...
    $mail->setFrom($_ENV['EMAIL_USERNAME'] ?? 'drackracer@gmail.com', 'Equipo de Retiro de Telas Modutext'); // Remitente
    $mail->addAddress($usuarioEmail); // Correo del destinatario
    $mail->addAddress($_ENV['EMAIL_USERNAME'] ?? 'drackracer@gmail.com'); // Opcional: Copia para el remitente
